...
.directive('appnav', [
    ...
    "GlobalState",
    "$stateParams",
    function (AuthToken, User, Card, Deck, $state, GlobalState, $stateParams) {
        return {
            restrict: "E",
            ...
            controller: function ($scope, $compile, $animate) {
                ...
                if ($stateParams.id) {
                    ...
                    Deck.getOne($stateParams.id)
                        .then( function (response) {
                            console.log(response.data);
                            $scope.activeDeck = response.data.title;
                        });
                }
                ...
                $scope.deckIndex = function () {
                    GlobalState.setState('CARD-INDEX-TO-DECK-INDEX');
                    $state.go('app');
                };
